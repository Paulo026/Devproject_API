...
public class ProdutoCategoriaController {
	...
	public ResponseEntity<ProdutoCategoriaDTO> buscarPorId(@PathVariable Integer categoriaId)
			throws ProdutoCategoriaException {
	...
	public ResponseEntity<String> atualizar(@PathVariable Integer categoriaId,
			@RequestBody ProdutoCategoriaDTO produtoCategoriaDTO) throws ProdutoCategoriaException {
